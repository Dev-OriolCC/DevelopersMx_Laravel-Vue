            ...
            <nav class="bg-white border-b border-gray-100">
                        ...
                        <div class="flex">
                            ...
                            <div class="flex-shrink-0 flex items-center">
                                <Link :href="route('index')">
                                    <h2 class="font-bold block h-9 w-auto text-2xl text-indigo-600">Developers Mexico</h2>
                                </Link>
                            </div>
                            <!-- //? Navigation Links -->
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div class="px-4">
                            <div class="font-medium text-base text-gray-800">{{ $page.props.auth.company.name }}</div>
                            <div class="font-medium text-sm text-gray-500">{{ $page.props.auth.company.company_name }}</div>
                        </div>
...
export default {
    components: {
        BreezeApplicationLogo, BreezeDropdown, BreezeDropdownLink, 
        BreezeDropdownLink, BreezeNavLink, BreezeResponsiveNavLink, Link
    },
    data() {
        return {
